		...
		<div class="row">
			<div class="col-sm-6">
				...
				<ul class="head-contact-social">
					...
					<li><a href="<?php echo esc_url($current_options['social_media_dropbox_link']); ?>" <?php if($current_options['db_link_new_tab']==true){ echo "target='_blank'"; } ?> ><i class="fa fa-instagram"></i></a></li>
					<?php } ?>
				</ul>
				<?php } ?>	
			</div>
