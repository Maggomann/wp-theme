		...
		<div class="row contact-form-section" id="myformdata">
			<div class="col-md-12">
				...
				<form role="form" class="form-inline" method="post"  action="#">
					...
					<input type="name" id="first_name" name="first_name" placeholder="<?php echo __( 'Vorname', 'wallstreet' ); ?>" class="blog-form-control">
					<span  style="display:none; color:red" id="contact_user_firstname_error"><?php _e('Vorname','wallstreet'); ?> </span>
					</div>
					<div class="cont-form-group">
					<input type="name" id="last_name" name="last_name" placeholder="<?php echo __( 'Nachname', 'wallstreet' ); ?>" class="blog-form-control">
					<span  style="display:none; color:red" id="contact_user_lastname_error"><?php _e('Nachname','wallstreet'); ?> </span>
					</div>
					<div class="cont-form-group">
					<input type="email" id="email" name="email" placeholder="<?php echo __( 'E-Mail', 'wallstreet' ); ?>" class="blog-form-control">
					<span  style="display:none; color:red" id="contact_user_email_error"><?php _e('E-Mail','wallstreet'); ?> </span>
					</div>
					<div class="cont-form-group">
					...
					<textarea placeholder="<?php echo __( 'Deine Nachricht', 'wallstreet' ); ?>" class="cont-form-control-textarea" id="massage" name="massage" rows="5"></textarea>
		...
		$flag=1;
			...
			{	if($flag==1)
				{	
					...
					$subject = trim($_POST['first_name']) ." ". trim($_POST['last_name']) ." gesendet von ". get_option("blogname");
					$massage = stripslashes(trim($_POST['massage']))."\r"."Message sent from: ".trim($_POST['email']);
					$headers = "From: ".trim($_POST['first_name'])." ".trim($_POST['last_name'])." <".trim($_POST['email']).">\r\r\n\nReply-To:".trim($_POST['email']);
