		...
		<?php if($current_options['home_slider_enabled'] == true) { 
			...
			<ul class="slides">
				...
				<li>
					...
					<div class="flex-slider-center">
						<div class="slide-text-bg1"><h2><?php _e('Art & Deko Manufactur' ,'wallstreet'); ?></h2></div>
						<div class="slide-text-bg2"><h1><?php _e('Welcome to Bo-Fabrik', 'wallstreet'); ?> 
						</h1></div>
						<div class="slide-text-bg3"><p><?php _e('#industriedesign #loftmöbel #upcycle #industrial-art #industrialchic #retro #restyle','wallstreet'); ?></p></div>
						<div class="flex_btn_div">
